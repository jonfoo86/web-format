...
exports.options = { 'angular-version': '1.4.6', 'angular-i18n-version': '1.4.6' };
...
exports.install = function() {
	...
	*/
	framework.helpers.ng = function(name) {
		...
		var script = $script_create((isCommon ? '/common/' + name + '.min.js' : '//cdn.bootcss.com/angular.js/' + exports.options['angular-version'] + '/' + name + '.min.js'));
	...
	framework.helpers.ngLocale = function(name) {
		...
		output += $script_create(isLocal ? '/i18n/angular-locale_' + name + extension : '//cdn.bootcss.com/angular.js/' + exports.options['angular-i18n-version'] + '/i18n/angular-locale_' + name + extension);
